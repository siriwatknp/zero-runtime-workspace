...
describe('grid generator', () => {
  describe('generateGridStyles', () => {
    it('root container', () => {
      const result = generateGridStyles({
        ownerState: { container: true, unstable_level: 0 },
      });
    ...
    it('nested container level 2', () => {
      const result = generateGridStyles({
        ownerState: { container: true, unstable_level: 2 },
      });
      sinon.assert.match(result, {
    ...
    it('item', () => {
      const result = generateGridStyles({
        ownerState: { container: false, unstable_level: 1 },
      });
      expect(result).to.deep.equal({
        minWidth: 0,
        boxSizing: 'border-box',
  ...
  describe('generateGridRowSpacingStyles', () => {
    ...
    it('nested item level 1 should have default spacing set to parent', () => {
      ...
      expect(result['--Grid-rowSpacingLevel1']).to.equal(
        'var(--Grid-rowSpacing)',
      );
    });
  });
  ...
  describe('generateGridColumnSpacingStyles', () => {
    ...
    it('nested item level 1 should have default spacing set to parent', () => {
      ...
      expect(result['--Grid-columnSpacingLevel1']).to.equal(
  ...
  describe('class names', () => {
    ...
    it('should work with any breakpoint', () => {
      ...
      expect(generateSpacingClassNames(2, 'mobile')).to.deep.equal([
        'spacing-mobile-2',
      ]);
  ...
  describe('generateDirectionClasses', () => {
    it('should generate correct direction class names', () => {
      ...
      expect(generateDirectionClasses('row')).to.deep.equal([
        'direction-xs-row',
      ]);
      expect(generateDirectionClasses('column')).to.deep.equal([
        'direction-xs-column',
      ]);
      expect(
        generateDirectionClasses({
