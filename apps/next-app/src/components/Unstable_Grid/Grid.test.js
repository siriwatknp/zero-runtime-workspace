...
describe('System <Grid />', () => {
  ...
  describe('prop: spacing', () => {
    ...
    it('should not support undefined values', () => {
      ...
      expect(container.firstChild).not.to.have.class(
  ...
  it('combines system properties with the sx prop', () => {
    const { container } = render(
      <Grid mt={2} mr={1} sx={{ marginRight: 5, mb: 2 }} />,
    );
  ...
  describe('prop: wrap', () => {
    ...
    it('should apply nowrap class and style', () => {
      const { container } = render(
        <Grid container wrap="nowrap" data-testid="wrap" />,
      );
    ...
    it('should apply wrap-reverse class and style', () => {
      const { container } = render(
        <Grid container wrap="wrap-reverse" data-testid="wrap" />,
      );
